            ...
            <div className="bg-background/50 p-8 rounded-xl border border-border/50 hover:shadow-lg transition-all duration-200">
              ...
              <div className="flex items-center gap-6">
                ...
                >
                  ...
                  <span className="text-sm font-medium">dan.mezistrano@mosaicsportcapital.com</span>
                </a>
              </div>
            </div>
            ...
            <div className="bg-background/50 p-8 rounded-xl border border-border/50 hover:shadow-lg transition-all duration-200">
              ...
              <div className="flex items-center gap-6">
                ...
                >
                  ...
                  <span className="text-sm font-medium">matthew.walzer@mosaicsportcapital.com</span>
                </a>
              </div>
            </div>
          </div>
