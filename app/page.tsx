            ...
            <div className="bg-background/50 p-8 rounded-xl border border-border/50 hover:shadow-lg transition-all duration-200">
              ...
              <div className="space-y-3">
                ...
                <div className="flex items-center gap-2 text-muted-foreground">
                  ...
                  <a href="mailto:dan.mezistrano@mosaicsportcapital.com" className="hover:text-primary transition-colors duration-200">
            ...
            <div className="bg-background/50 p-8 rounded-xl border border-border/50 hover:shadow-lg transition-all duration-200">
              ...
              <div className="space-y-3">
                ...
                <div className="flex items-center gap-2 text-muted-foreground">
                  ...
                  <a href="mailto:matthew.walzer@mosaicsportcapital.com" className="hover:text-primary transition-colors duration-200">
            ...
            <form onSubmit={handleSubmit} className="space-y-6">
              ...
              <div className="text-center">
                <button
                  ...
                  className="bg-primary text-white px-8 py-3 rounded-lg font-medium hover:bg-primary/90 transition-colors focus:ring-2 focus:ring-primary focus:ring-offset-2 disabled:opacity-50 disabled:cursor-not-allowed"
                >
